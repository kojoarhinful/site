...
export const content = `For a good while now, I've been working on making a little spot for myself online. I wanted a place where I could write down what I'm learning, share some personal thoughts, and just keep track of things that matter to me. It's been a bit of a journey, but guess what? I finally got it done 😅.
...
So yeah, this is my little corner of the internet now. I'm excited to start using it more. Looking forward to filling this space with all sorts of things.
